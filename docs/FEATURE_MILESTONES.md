...
|---|---|---|---|
| Recently closed tabs | ◐ | stack of 10 + Ctrl+Shift+T only; no "Recently Closed" menu list, favicon/session metadata not kept | M2 |
...
| 2.2 | Recently-closed-tabs menu | ◐ | extend existing stack into History-menu submenu |
